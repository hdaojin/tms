...
class MenuItem(models.Model):
    ...
    # 指向方式1：命名路由
    # named_url 的可选值由自定义表单 MenuItemForm 动态提供（见 navigation/forms.py）
    named_url = models.CharField("命名路由", max_length=200, blank=True, help_text="从已发现的命名URL列表中选择；留空表示不使用命名路由")
