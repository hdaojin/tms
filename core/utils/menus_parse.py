...
def build_menu_tree_for_flatpages(request) -> list[dict]:
    ...
    Returns:
        list(dict): 菜单树列表
    """
    flatpage_menus = resources.files("core").joinpath("menus/menus_flatpage.yml")
...
def build_menu_tree_for_header(request) -> list[dict]:
    ...
    构建顶部菜单树
    """
    header_menus = resources.files("core").joinpath("menus/menus_header.yml")
