...
class ExamPaperListView(TitleMixin, LoginRequiredMixin, SingleTableView):
    model = ExamPaper
...
class ExamPaperDetailView(TitleMixin, LoginRequiredMixin, DetailView):
    model = ExamPaper
...
class ExamRequirementListView(TitleMixin, LoginRequiredMixin, SingleTableView):
...
class ExamRequirementDetailView(TitleMixin, LoginRequiredMixin, DetailView):
    model = ExamRequirement
