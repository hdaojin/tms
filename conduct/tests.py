...
from conduct.admin import ConductCategoryAdmin, ConductItemAdmin, ConductRecordAdmin, ConductSeverityRuleAdmin
from conduct.models import ConductCategory, ConductItem, ConductRecord, ConductSeverityRule, ConductSummary
...
class ConductRecordAdminTestCase(TestCase):
    ...
    def test_severity_choices_endpoint_returns_reward_labels(self):
        request = self.factory.get(
            '/admin/conduct/conductrecord/severity-choices/',
...
class ConductAuditAdminTestCase(TestCase):
    ...
    def build_request(self, user):
        request = self.factory.get('/admin/conduct/')
        request.user = user
        return request
